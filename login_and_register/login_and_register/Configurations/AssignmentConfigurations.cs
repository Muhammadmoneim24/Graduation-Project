...
namespace login_and_register.Configurations
{
    public class AssignmentConfigurations : IEntityTypeConfiguration<Assignment>
    {
        public void Configure(EntityTypeBuilder<Assignment> builder)
        {
            ...
            builder.Property(a =>a.Tittle).HasColumnType("VARCHAR").HasMaxLength(100).IsRequired();
            builder.Property(a => a.Describtion).HasColumnType("VARCHAR").HasMaxLength(500).IsRequired();
