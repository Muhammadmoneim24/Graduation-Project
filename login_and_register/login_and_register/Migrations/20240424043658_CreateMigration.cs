        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseName = table.Column<string>(type: "VARCHAR(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tittle = table.Column<string>(type: "VARCHAR(500)", maxLength: 500, nullable: false),
                    Describtion = table.Column<string>(type: "VARCHAR(1000)", maxLength: 1000, nullable: true),
                    EndDate = table.Column<string>(type: "VARCHAR(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tittle = table.Column<string>(type: "VARCHAR(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    Tittle = table.Column<string>(type: "VARCHAR(255)", maxLength: 255, nullable: true),
                    Describtion = table.Column<string>(type: "VARCHAR(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LecFile = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CourseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseNotificationss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseNotificationss_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseNotificationss_Notifications_NotificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectAnswer = table.Column<string>(type: "VARCHAR(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentAnswer = table.Column<string>(type: "VARCHAR(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseNotificationss_CourseId",
                table: "CourseNotificationss",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseNotificationss_NotificationId",
                table: "CourseNotificationss",
